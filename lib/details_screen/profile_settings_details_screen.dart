...
import 'package:food_app/models/userdetails_model.dart';
import 'package:food_app/provider/api_calls.dart';
import 'package:food_app/services/userdetails_api/userdetails_api.dart';
      ...
      body: FutureBuilder<Userdetails>(
        future:profile.getuserdetails() ,
          builder: (c,    snapshot) {
            ...
            _nameController.text  = snapshot.data!.user!.name??_nameController.text;
            _email.text  = snapshot.data!.user!.email??_nameController.text;
            _password.text  = snapshot.data!.user!.phone??_nameController.text;
                      ...
                      Center(
                        child: Container(
                            ...
                            child: MaterialButton(
                                ...
                                onPressed: () {
                                  profile.updateuserdetails(_nameController.text, _password.text);
